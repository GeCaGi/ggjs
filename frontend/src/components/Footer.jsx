              ...
              <div className="it-brand-wrapper">
                <a href="#">
                  ...
                  <div className="it-brand-text">
                    ...
                    <h3 className="no_toc d-none d-md-block">Inserire qui la tag line</h3>
                  </div>
                </a>
              </div>
            </div>
        ...
        <section>
          <div className="row">
            <div className="col-lg-3 col-md-3 col-sm-6 pb-2">
              ...
              <div className="link-list-wrapper">
                <ul className="footer-list link-list clearfix">
                  <li><a className="list-item" href="#" title="Vai alla pagina: Giunta e consiglio">Giunta e consiglio</a>
                  </li>
                  <li><a className="list-item" href="#" title="Vai alla pagina: Aree di competenza">Aree di competenza</a>
                  </li>
            ...
            <div className="col-lg-3 col-md-3 col-sm-6 pb-2">
              ...
              <div className="link-list-wrapper">
                <ul className="footer-list link-list clearfix">
                  ...
                  <li><a className="list-item" href="#" title="Vai alla pagina: Domande e iscrizioni">Domande e
                      iscrizioni</a></li>
                  <li><a className="list-item" href="#" title="Vai alla pagina: Segnalazioni">Segnalazioni</a></li>
                  <li><a className="list-item" href="#" title="Vai alla pagina: Autorizzazioni e concessioni">Autorizzazioni
                      e concessioni</a></li>
                  <li><a className="list-item" href="#" title="Vai alla pagina: Certificati e dichiarazioni">Certificati e
                      dichiarazioni</a></li>
                </ul>
              </div>
            </div>
            <div className="col-lg-3 col-md-3 col-sm-6 pb-2">
              ...
              <div className="link-list-wrapper">
                <ul className="footer-list link-list clearfix">
                  ...
                  <li><a className="list-item" href="#" title="Vai alla pagina: Comunicati stampa">Comunicati stampa</a>
                  </li>
                </ul>
              </div>
            </div>
            <div className="col-lg-3 col-md-3 col-sm-6">
              ...
              <div className="link-list-wrapper">
                <ul className="footer-list link-list clearfix">
                  <li><a className="list-item" href="#" title="Vai alla pagina: Progetti e attività">Progetti e attività</a>
                  </li>
                  <li><a className="list-item" href="#" title="Vai alla pagina: Delibere, determine e ordinanze">Delibere,
          ...
          <div className="row">
            <div className="col-lg-4 col-md-4 pb-2">
              ...
              <p className="list-item">
                <strong>IIS Giovanni GIORGI</strong><br />
                Viale Liguria 19 - 20143 Milano C.f. 000000000
              </p>
              <div className="link-list-wrapper">
                <ul className="footer-list link-list clearfix">
              ...
              <div className="pb-2">
                ...
                <ul className="list-inline text-left social">
                  <li className="list-inline-item">
                    <a className="p-2 text-white" href="#" target="_blank"><svg className="icon icon-sm icon-white align-top">
                      </svg><span className="visually-hidden">Designers Italia</span></a>
                  </li>
                  <li className="list-inline-item">
                    <a className="p-2 text-white" href="#" target="_blank"><svg className="icon icon-sm icon-white align-top">
                      </svg><span className="visually-hidden">Twitter</span></a>
                  </li>
                  <li className="list-inline-item">
                    <a className="p-2 text-white" href="#" target="_blank"><svg className="icon icon-sm icon-white align-top">
                      </svg><span className="visually-hidden">Medium</span></a>
                  </li>
                  <li className="list-inline-item">
                    <a className="p-2 text-white" href="#" target="_blank"><svg className="icon icon-sm icon-white align-top">
                      </svg><span className="visually-hidden">Behance</span></a>
                  </li>
                </ul>
              </div>
            </div>
