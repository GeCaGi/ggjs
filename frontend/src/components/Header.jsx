...
export default function Header(){
  ...
  // Usage of setCookie to include expiration date
  function setSessionCookies(username) {
    const now = new Date();
  ...
  useEffect(() => {
    ...
    if (!getInfoFromCookies()) {
      deleteCookie("username")
      location.assign("/login")
    } else {
      setSessionCookies(getInfoFromCookies().username)
    }
  }, [])
